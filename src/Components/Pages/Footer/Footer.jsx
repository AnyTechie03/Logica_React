      ...
      <footer className="footer">
        <div className="row p-0 m-0">
          <div className="copyright col-md-12 p-0 text-center">
            ...
            <a onClick={() => togglePrivacy()}  style={subt}> |  Privacy Policy</a>
          </div>
          </div>
          
          {showTerms && (
           <div className="terms-content  col-md-12 p-3"  style={{ color: "#fff"}}>
              <i className="fa-solid fa-xmark" style={{ color: "#fff"}} onClick={() => setShowTerms(!showTerms)}></i>
              <h2>Terms & Conditions</h2>
              <p>Last updated on Oct 12th, 2023</p>
              <p>
                The Website Owner, including subsidiaries and affiliates (“Website” or “Website Owner” or “we” or “us” or “our”) provides
              ...
              <p>
                ...
                following terms and conditions of use, which together with our privacy policy govern Logica By SIMCA''s relationship with
                you in relation to this website.
              </p>
              <p>

                The term 'Logica By SIMCA' or 'us' or 'we' refers to the owner of the website whose registered/operational office is Sinhgad Institute of Management And Computer Application Narhe Pune MAHARASHTRA 411041.
...
You may not create a link to this website from another website or document without Logica By SIMCA’s prior written consent.
  </li>
  <li>
...
on Account of the Cardholder having exceeded the preset limit mutually agreed by us with our acquiring bank from time to time
              </p>
...
{showContact && (
            <div className="terms-content  col-md-12 p-3"  style={{ color: "#fff"}}>
              <i className="fa-solid fa-xmark" style={{ color: "#fff"}}  onClick={() => setContact(!showContact)} ></i>
              <h2>Contact us</h2>
              <p>Last updated on Oct 12th, 2023</p>
              <p>
...
Merchant Legal entity name: Logica By SIMCA<br/>
Registered Address: Sinhgad Institute of Management And Computer Application Narhe Pune MAHARASHTRA 411041 <br/>
Operational Address: Sinhgad Institute of Management And Computer Application Narhe Pune MAHARASHTRA 411041<br/>
E-Mail ID: logica.simca@gmail.com<br/>
              </p>
...
{showCancellation && (
           <div className="terms-content  col-md-12 p-3"  style={{ color: "#fff"}}>
              <i className="fa-solid fa-xmark" style={{ color: "#fff"}}  onClick={() => setCancellation(!showCancellation)}></i>
...
No cancellations & Refunds are entertained
          ...
          {showPrivacy && (
           <div className="terms-content  col-md-12 p-3"  style={{ color: "#fff"}}>
              <i className="fa-solid fa-xmark" style={{ color: "#fff"}}  onClick={() => setPrivacy(!showPrivacy)} ></i>
              <h2>Privacy Policy</h2>
              <p>Last updated on Oct 12th, 2023</p>
              <p>
              This privacy policy sets out how Logica By SIMCA uses and protects any information that you give Logica By SIMCA when you use this website.
              </p>
              <p>
              Logica By SIMCA is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, and then you can be assured that it will only be used in accordance with this privacy statement.
              </p>
              <p>
              Logica By SIMCA may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes.
              </p>
              <p>
...
<li>Other information relevant to customer surveys and/or offers</li></ul>
              ...
              <p><b>What we do with the information we gather</b><br/>
...
<ul>
  ...
  <li>
  if you have previously agreed to us using your personal information for direct marketing purposes, you may change your mind at any time by writing to or emailing us at logica.simca@gmail.com
  </li>
</ul>
              </p>
              <p>
