...
<div className="face face2">
<h2 className="lsubtitle text-center">Level 03 CodeVersa</h2>
</div>
</div>
     </div>
          <div className="row mt-5 dbtn">
          <a className="col-12 btn justify-content-around" href="https://drive.google.com/file/d/1Mc3eTQiMUGQBx3qiaRhoFZoaYa0zQQBp/view?usp=drive_link" role="button" target="_blank">
