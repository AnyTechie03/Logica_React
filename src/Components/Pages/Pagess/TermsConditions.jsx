  ...
  return (
    <div className="PayContainer">
      ...
      <p>
        ...
        conditions of use, which together with our privacy policy govern Logica
        By SIMCA''s relationship with you in relation to this website.
      </p>
      <p>
        The term 'Logica By SIMCA' or 'us' or 'we' refers to the owner of the
        website whose registered/operational office is Sinhgad Institute of
        Management And Computer Application Narhe Pune MAHARASHTRA 411041. The
      ...
      <ul>
        ...
        <li>
          ...
          document without Logica By SIMCA’s prior written consent.
        </li>
        <li>
